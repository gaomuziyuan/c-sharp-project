...
namespace Colyn_Purchasing.DAL
{
    internal partial class EbikePurchasingContext : DbContext
    {
        public EbikePurchasingContext()
        {
        }

        public EbikePurchasingContext(DbContextOptions<EbikePurchasingContext> options)
            : base(options)
        {
        }
